...
task :default =>[ :nutrientes_prueba, :lista_prueba, :alimentos_prueba, :indGlu_prueba ]
...
desc "Ejecutar las espectativas de la clase índice glucémico"
task :indGlu_prueba do
  sh "rspec -I. spec/ig_spec.rb"
end